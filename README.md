...
<header>
    ...
    <p>Computer Science Student @ University of Notre Dame</p>
</header>
...
<section id="projects">
    ...
    <ul>
        ...
        <li><strong>findit (Unix C Project):</strong> Developed a C program to recursively search files based on permissions and type.</li>
        ...
        <li><strong>MIT edX Python Course:</strong> Completed MITx 6.00.1x Introduction to Computer Science and Programming in Python.</li>
    </ul>
</section>
